...
- rm -r Y && rm -rf Y : Recursively delete a directory Y and its contents & Forcibly remove directory Y and its contents
recursively
...
-  htop : Display sorted information about processes with visual highlights. It allows you to scroll
  vertically and horizontally, so you can see every process running on your system and entire commands.
